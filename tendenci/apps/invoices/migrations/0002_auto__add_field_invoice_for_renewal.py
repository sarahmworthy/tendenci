...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.for_renewal'
        db.add_column('invoices_invoice', 'for_renewal', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.for_renewal'
        db.delete_column('invoices_invoice', 'for_renewal')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 23, 16, 47, 1, 272535)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 23, 16, 47, 1, 272432)'}),
        ...
        'invoices.invoice': {
            ...
            'for_renewal': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
