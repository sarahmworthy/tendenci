...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.sso_user'
        db.add_column('profiles_profile', 'sso_user', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.sso_user'
        db.delete_column('profiles_profile', 'sso_user')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 26, 1, 49, 13, 29579)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 26, 1, 49, 13, 29479)'}),
        ...
        'profiles.profile': {
            ...
            'sso_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
