...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Box.image'
        db.delete_column('boxes_box', 'image_id')

        # Deleting field 'Box.link'
        db.delete_column('boxes_box', 'link')

        # Deleting field 'Box.link_title'
        db.delete_column('boxes_box', 'link_title')
    ...
    models = {
        ...
        'boxes.box': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['files.File']", 'null': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'link_title': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
