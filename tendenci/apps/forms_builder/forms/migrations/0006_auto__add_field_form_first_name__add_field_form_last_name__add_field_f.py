...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Form.zip'
        db.add_column('forms_form', 'zip', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        # Adding field 'Form.message'
        db.add_column('forms_form', 'message', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Field.map_to_field'
        db.add_column('forms_field', 'map_to_field', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Form.zip'
        db.delete_column('forms_form', 'zip')
        ...
        # Deleting field 'Form.message'
        db.delete_column('forms_form', 'message')

        # Deleting field 'Field.map_to_field'
        db.delete_column('forms_field', 'map_to_field')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 19, 1, 21, 32, 609407)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 19, 1, 21, 32, 609311)'}),
