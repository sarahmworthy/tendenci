...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field payment_gateways on 'Form'
        db.create_table('forms_form_payment_gateways', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('form', models.ForeignKey(orm['forms.form'], null=False)),
            ('paymentgateway', models.ForeignKey(orm['payments.paymentgateway'], null=False))
        ))
        db.create_unique('forms_form_payment_gateways', ['form_id', 'paymentgateway_id'])

        # Adding field 'FormEntry.payment_gateway'
        db.add_column('forms_formentry', 'payment_gateway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentGateway'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing M2M table for field payment_gateways on 'Form'
        db.delete_table('forms_form_payment_gateways')

        # Deleting field 'FormEntry.payment_gateway'
        db.delete_column('forms_formentry', 'payment_gateway_id')
    ...
    models = {
        ...
        'forms.form': {
            ...
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'payment_gateways': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['payments.PaymentGateway']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'forms.formentry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment_gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['payments.PaymentGateway']", 'null': 'True'}),
