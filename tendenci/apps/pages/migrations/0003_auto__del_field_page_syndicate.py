...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Page.syndicate'
        db.delete_column('pages_page', 'syndicate')


    def backwards(self, orm):
        
        # Adding field 'Page.syndicate'
        db.add_column('pages_page', 'syndicate', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 14, 6, 43, 37, 580251)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 14, 6, 43, 37, 580156)'}),
