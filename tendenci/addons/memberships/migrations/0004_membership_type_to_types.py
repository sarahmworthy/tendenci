...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Includes the Notice's current membership type to the new
        many to many field for it
        """
        notices = orm.Notice.objects.all()
        for notice in notices:
            notice.membership_types.add(notice.membership_type)
            notice.save()


    def backwards(self, orm):
        """Rolls back forwards migration"""
        notices = orm.Notice.objects.all()
        for notice in notices:
            types = notice.membership_types.all()
            if types:
                notice.membership_type = types[0]
                notice.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 9, 2, 14, 53, 206266)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 9, 2, 14, 53, 206173)'}),
