...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Notice.membership_type'
        db.delete_column('memberships_notice', 'membership_type_id')


    def backwards(self, orm):
        
        # Adding field 'Notice.membership_type'
        db.add_column('memberships_notice', 'membership_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memberships.MembershipType'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 9, 2, 58, 29, 276793)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 9, 2, 58, 29, 276600)'}),
