...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field membership_types on 'Notice'
        db.create_table('memberships_notice_membership_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notice', models.ForeignKey(orm['memberships.notice'], null=False)),
            ('membershiptype', models.ForeignKey(orm['memberships.membershiptype'], null=False))
        ))
        db.create_unique('memberships_notice_membership_types', ['notice_id', 'membershiptype_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field membership_types on 'Notice'
        db.delete_table('memberships_notice_membership_types')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 8, 23, 49, 34, 497705)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 8, 23, 49, 34, 497550)'}),
        ...
        'memberships.notice': {
            ...
            'membership_types': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'notices'", 'symmetrical': 'False', 'to': "orm['memberships.MembershipType']"}),
