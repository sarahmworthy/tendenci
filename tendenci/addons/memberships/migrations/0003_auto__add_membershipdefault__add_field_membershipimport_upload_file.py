...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('memberships_membershipdefault', (
            ...
            ('expire_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ...
            ('generate_member_number', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('application_abandoned', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('application_abandoned_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('application_abandoned_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='application_abandond_set', to=orm['auth.User'])),
            ('application_complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('application_complete_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('application_complete_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='application_complete_set', to=orm['auth.User'])),
            ('application_approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('application_approved_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('application_approved_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='application_approved_set', to=orm['auth.User'])),
            ('action_taken', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('action_taken_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('action_taken_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='action_taken_set', to=orm['auth.User'])),
            ('bod_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('personnel_notified_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('payment_received_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('payment_method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentMethod'])),
            ('override', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('override_price', self.gf('django.db.models.fields.FloatField')()),
            ('exported', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('application_approved_denied_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('application_approved_denied_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='application_approved_denied_set', to=orm['auth.User'])),
            ...
            ('organization_entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organization_set', to=orm['entities.Entity'])),
            ('corporate_entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='corporate_set', to=orm['entities.Entity'])),
            ('corporate_membership_id', self.gf('django.db.models.fields.IntegerField')()),
            ('renew_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ...
            ('sig_user_group_ids', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
    ...
    models = {
        ...
        'memberships.membershipdefault': {
            ...
            'action_taken_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'action_taken_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'action_taken_set'", 'to': "orm['auth.User']"}),
            'admin_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'application_abandoned_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'application_abandoned_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'application_abandond_set'", 'to': "orm['auth.User']"}),
            'application_approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'application_approved_denied_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'application_approved_denied_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'application_approved_denied_set'", 'to': "orm['auth.User']"}),
            'application_approved_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'application_approved_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'application_approved_set'", 'to': "orm['auth.User']"}),
            'application_complete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'application_complete_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'application_complete_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'application_complete_set'", 'to': "orm['auth.User']"}),
            ...
            'bod_dt': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'corporate_entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'corporate_set'", 'to': "orm['entities.Entity']"}),
            'corporate_membership_id': ('django.db.models.fields.IntegerField', [], {}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'expire_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'exported': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'generate_member_number': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'organization_entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'organization_set'", 'to': "orm['entities.Entity']"}),
            'override': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'override_price': ('django.db.models.fields.FloatField', [], {}),
            ...
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'payment_method': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['payments.PaymentMethod']"}),
            'payment_received_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'personnel_notified_dt': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'renew_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'renewal': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sig_user_group_ids': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
