...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MembershipDefault.payment_gateway'
        db.add_column('memberships_membershipdefault', 'payment_gateway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentGateway'], null=True), keep_default=False)

        # Adding M2M table for field payment_gateways on 'MembershipApp'
        db.create_table('memberships_membershipapp_payment_gateways', (
        ...
        db.create_unique('memberships_membershipapp_payment_gateways', ['membershipapp_id', 'paymentgateway_id'])


    def backwards(self, orm):
        
        # Deleting field 'MembershipDefault.payment_gateway'
        db.delete_column('memberships_membershipdefault', 'payment_gateway_id')

        # Removing M2M table for field payment_gateways on 'MembershipApp'
        db.delete_table('memberships_membershipapp_payment_gateways')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 3, 27, 18, 917577)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 3, 27, 18, 917472)'}),
