...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CorpMembership.payment_gateway'
        db.add_column('corporate_memberships_corpmembership', 'payment_gateway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentGateway'], null=True), keep_default=False)

        # Adding M2M table for field payment_gateways on 'CorpMembershipApp'
        db.create_table('corporate_memberships_corpmembershipapp_payment_gateways', (
        ...
        db.create_unique('corporate_memberships_corpmembershipapp_payment_gateways', ['corpmembershipapp_id', 'paymentgateway_id'])


    def backwards(self, orm):
        
        # Deleting field 'CorpMembership.payment_gateway'
        db.delete_column('corporate_memberships_corpmembership', 'payment_gateway_id')

        # Removing M2M table for field payment_gateways on 'CorpMembershipApp'
        db.delete_table('corporate_memberships_corpmembershipapp_payment_gateways')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 4, 5, 33, 323770)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 4, 5, 33, 323567)'}),
        ...
        'corporate_memberships.corpmembershipapp': {
            ...
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'payment_gateways': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['payments.PaymentGateway']", 'symmetrical': 'False'}),
            'payment_methods': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['payments.PaymentMethod']", 'symmetrical': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '155', 'db_index': 'True'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
