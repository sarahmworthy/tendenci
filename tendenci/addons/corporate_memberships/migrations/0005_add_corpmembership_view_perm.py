...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Add the permission entry for view_corpmembership if not exists.
        """
        from tendenci.addons.corporate_memberships.models import CorpMembership
        content_type = ContentType.objects.get_for_model(CorpMembership)
        name = 'Can view corporate membership'
        codename = 'view_corpmembership'
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 29, 13, 1, 50, 153308)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 29, 13, 1, 50, 153199)'}),
