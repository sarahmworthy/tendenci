...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field payment_gateway on 'RegistrationConfiguration'
        db.create_table('events_registrationconfiguration_payment_gateway', (
        ...
        db.create_unique('events_registrationconfiguration_payment_gateway', ['registrationconfiguration_id', 'paymentgateway_id'])

        # Adding field 'Registration.payment_gateway'
        db.add_column('events_registration', 'payment_gateway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentGateway'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing M2M table for field payment_gateway on 'RegistrationConfiguration'
        db.delete_table('events_registrationconfiguration_payment_gateway')

        # Deleting field 'Registration.payment_gateway'
        db.delete_column('events_registration', 'payment_gateway_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 3, 25, 32, 913991)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 3, 25, 32, 913880)'}),
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 11, 5, 25, 30, 687925)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 11, 3, 25, 30, 687867)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'allow_member': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 11, 9, 25, 30, 672798)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 3, 25, 30, 672746)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'events.registrationconfiguration': {
            ...
            'payment_gateway': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['payments.PaymentGateway']", 'symmetrical': 'False'}),
