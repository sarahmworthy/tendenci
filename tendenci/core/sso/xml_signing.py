...
from tendenci.core.sso.codex import nice64
from tendenci.core.sso.xml_templates import SIGNED_INFO, SIGNATURE
...
def get_signature_xml(subject, reference_uri):
    ...
    """
    private_key_file = sso_settings.SSO_PRIVATE_KEY_FILE
    certificate_file = sso_settings.SSO_CERTIFICATE_FILE
